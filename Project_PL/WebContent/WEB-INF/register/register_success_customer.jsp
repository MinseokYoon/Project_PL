         ...
         <div class="row">
            <div class="col-sm-4">
               <div class="logo pull-left">
                  <a href="${initParam.rootPath }/index.do"><img
                     src="/Project_PL/images/home/logo.png" alt="홈으로" /></a>
               </div>
            </div>
            <div class="col-sm-8">
...
<div class="container">
   <div class="row">
     ...
     <a  class="btn btn-primary" href="${initParam.rootPath}/basic/item_list.do" method="post" >메인화면으로</a> 
               <br/>
               <br/>
               <br/>
               <br/>
