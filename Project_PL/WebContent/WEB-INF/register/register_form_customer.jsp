			...
			<div class="row">
				<div class="col-sm-4">
					<div class="logo pull-left">
						<a href="${initParam.rootPath }/basic/item_list.do"><img src="/Project_PL/images/pline.png" alt="홈으로" /></a>
					</div>
				</div>
				<div class="col-sm-8">
		...
		<div class="row">
			<div class="col-sm-4 col-sm-offset-4">
				<div class="signup-form">
					...
					<form action="/Project_PL/customer/add.do">
						<input type="text" name="customerId" placeholder="아이디" /> <form:errors path="customer.id" />
						<input type="password" name="customerPassword" placeholder="비밀번호" /> <form:errors path="customer.password" />
						<input type="text" name="customerName" placeholder="이름" /> 	<form:errors path="customer.name" />
						<input type="text" name="customerAddress" placeholder="주소(50자 이내)" height="100px" />  <form:errors path="customer.address" />
						<input type="text" name="customerBirth" placeholder="생년월일 (예 : 20151117)" /> <form:errors path="customer.birth" />

						&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
						<font size="3">남자</font>
						&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input
							name="customerGender" type="radio" value="1"
							style="width: 15px; height: 15px; border: 5px" ;/>
						&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <font size="3"> 여자</font>
						&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<input
							name="customerGender" type="radio" value="2"
							style="width: 15px; height: 15px; border: 5px" ;/> <input
							type="text" name="customerPhone"
							placeholder="전화번호 (예: 01012345678)" /> <form:errors path="customer.phone" />
						<table width="100%">
							<tr>
								<td><input type="text" name="customerEmail"
									placeholder="이메일 (예: example@example.com)" /></td>
							</tr>
						</table>
