			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="signup-form"><!--login form-->
						<h2>마이페이지</h2></label>
						<form action="${initParam.rootPath }/admin/modify.do">
							<input type="text" name="adminId" value="${sessionScope.sessionUser.adminId }">
							<input type="password" name="adminPassword" value="${sessionScope.sessionUser.adminPassword }">
							<input type="text" name="adminName" value="${sessionScope.sessionUser.adminName }">
							<input type="text" name="adminPhone" value="${sessionScope.sessionUser.adminPhone }">
