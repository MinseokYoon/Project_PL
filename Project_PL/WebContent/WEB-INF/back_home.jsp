...
<body>
	<div class="container text-center">
		...
		<div class="content-404">
			<img src="${initParam.rootPath }/images/404/404.png" width="400px" height="300px" class="img-responsive" alt="" />
			<h1><b>죄송합니다.</b> 로그인 후 사용해 주세요. </h1>
			<p>로그인 하시면 다양한 서비스를 받아 보실 수 있습니다.</p>
			<h2><a href="${initParam.rootPath }/basic/login_form.do">로그인 페이지 이동</a></h2>
		</div>
	</div>
