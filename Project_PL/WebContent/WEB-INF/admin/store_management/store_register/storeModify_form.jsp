...
<link rel="shortcut icon"
	href="${initParam.rootPath}/images/ico/favicon.ico">
<link rel="apple-touch-icon-precomposed" sizes="144x144"
	href="${initParam.rootPath}/images/ico/apple-touch-icon-144-precomposed.png">
<link rel="apple-touch-icon-precomposed" sizes="114x114"
	href="${initParam.rootPath}/images/ico/apple-touch-icon-114-precomposed.png">
<link rel="apple-touch-icon-precomposed" sizes="72x72"
	href="${initParam.rootPath}/images/ico/apple-touch-icon-72-precomposed.png">
<link rel="apple-touch-icon-precomposed"
	href="${initParam.rootPath}/images/ico/apple-touch-icon-57-precomposed.png">
</head>
<body>
	...
	<section>
		<div class="container">
			...
			<div class="product list paging">
				...
				<form action="${initParam.rootPath}/admin/storeModify.do"
					method="post" id="modifyForm">
					<input type="hidden" name="pageNo" value="${param.pageNo }">
					<table border="1" style="width: 500px">
						<tr>
							<th style="text-align: center; background-color: #FAE0D4;">편의점
								ID</th>
							<td>${requestScope.store.storeId } <input type="hidden"
								name="storeId" id="storeId"
								value="${requestScope.store.storeId }">
							</td>
						</tr>
						<tr>
							<th style="text-align: center; background-color: #FAE0D4;">지점</th>
							<td><input type="text" id="storeName" name="storeName"
								size="25" value="${requestScope.store.storeName }"> <span
								class="errorMessage"><form:errors path="store.storeName"
										delimiter=" | " /></span></td>
						</tr>
						<tr>
							<th style="text-align: center; background-color: #FAE0D4;">주소</th>
							<td><input type="text" id="storeAddress" name="storeAddress"
								size="25" value="${requestScope.store.storeAddress }"> <span
								class="errorMessage"><form:errors
										path="store.storeAddress" delimiter=" | " /></span></td>
						</tr>
						<tr>
							<th style="text-align: center; background-color: #FAE0D4;">전화번호</th>
							<td><input type="text" id="storePhone" name="storePhone"
								size="25" value="${requestScope.store.storePhone}"> <span
								class="errorMessage"><form:errors path="store.storePhone"
										delimiter=" | " /></span></td>
						</tr>
						<tr>
							<th style="text-align: center; background-color: #FAE0D4;">사업번호</th>
							<td><input type="text" id="storeLicense" name="storeLicense"
								size="25" value="${requestScope.store.storeLicense}"> <span
								class="errorMessage"><form:errors
										path="store.storeLicense" delimiter=" | " /></span></td>
						</tr>
						<tr>
				...
				<div class="col-sm-7">
					...
					<div class="col-sm-3">
						<div class="video-gallery text-center">
							<a href="#">
								<div class="iframe-img">
									<img src="${initParam.rootPath}/images/home/IMG_0248.PNG"
										alt="" />
								</div>
								<div class="overlay-icon">
									<i class="fa fa-play-circle-o"></i>
					...
					<div class="col-sm-3">
						<div class="video-gallery text-center">
							<a href="#">
								<div class="iframe-img">
									<img src="${initParam.rootPath}/images/home/IMG_0362.JPG"
										alt="" />
								</div>
								<div class="overlay-icon">
									<i class="fa fa-play-circle-o"></i>
