			...
			<div class="product list paging">
				...
				<c:choose>
					<c:when test="${fn:length(requestScope.list)==0 }">
							등록된 편의점이 없습니다.<p>
							<a href="${initParam.rootPath}/admin/storeList.do">처음으로</a>
						</c:when>
					<c:otherwise>
						<table style="width: 800px" border="1">
							<tr color="red">
								...
								<th style="text-align: center; background-color: #FAE0D4;">점주
									전화번호</th>
							</tr>
							<c:forEach items="${requestScope.list }" var="store">
								<tr>
									<td>${store.storeId }</td>
									<td><a
										href="${initParam.rootPath}/admin/storeFindById.do?storeId=${store.storeId }&pageNo=${requestScope.pagingBean.currentPage}">${store.storeName}</a>
									</td>
								...
								<td colspan="7" align="center">
									<!-- Paging 처리 --> <!-- 
										...
										<c:when test="${requestScope.pagingBean.previousPageGroup }">
											<a
												href="${initParam.rootPath }/admin/storeList.do?pageNo=${requestScope.pagingBean.startPageOfPageGroup-1}">
												◀ </a>
										</c:when>
										<c:otherwise>
										 		◀
										...
										<c:choose>
											...
											<c:otherwise>
												<a
													href="${initParam.rootPath }/admin/storeList.do?pageNo=${page }">
													${page } </a>
											</c:otherwise>
										</c:choose>
											&nbsp;&nbsp;
										...
										<c:when test="${requestScope.pagingBean.nextPageGroup }">
											<a
												href="${initParam.rootPath }/admin/storeList.do?pageNo=${requestScope.pagingBean.endPageOfPageGroup+1}">
												▶ </a>
										</c:when>
				...
				<div class="search_box pull-left">
					<form name="storeSearch"
						action="${initParam.rootPath }/admin/StoreByName.do" method="post"
						onsubmit="return storeSearchCheck();">
