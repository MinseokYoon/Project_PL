				...
				<div class="product list paging">
					...
					<table border="1" style="width:300px">
						...
						<tr>
							...
							<td>${requestScope.store.storeAddress }</td>
						</tr>
						<tr>
						...
						<tr>
							<th style="text-align: center; background-color: #FAE0D4;">사업 번호</th>
							<td>${requestScope.store.storeLicense }</td>
						</tr>
					</table>
					<a href="${initParam.rootPath}/admin/storeRemove.do?storeId=${requestScope.store.storeId }&pageNo=${param.pageNo}">삭제</a>
					<a href="${initParam.rootPath}/admin/storeModifyForm.do?storeId=${requestScope.store.storeId }&pageNo=${param.pageNo}">정보수정</a>
				</div>
			</div>
		</div>
	</section>
