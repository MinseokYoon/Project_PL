				...
				<div class="product list paging">
					...
					<table border="1" style="width:300px">
						<tr>
							...
							<td>${requestScope.owner.ownerId }</td>
						</tr>
						<tr>
							<th style="text-align: center; background-color: #FAE0D4;">이름</th>
							<td>${requestScope.owner.ownerName }</td>
						</tr>
						<tr>
							<th style="text-align: center; background-color: #FAE0D4;">전화번호</th>
							<td>${requestScope.owner.ownerPhone }</td>
						</tr>
					</table>
					<a href="${initParam.rootPath}/owner/ownerRemove.do?ownerId=${requestScope.owner.ownerId }&pageNo=${param.pageNo}">삭제</a>
				</div>
			</div>
		</div>
	</section>
