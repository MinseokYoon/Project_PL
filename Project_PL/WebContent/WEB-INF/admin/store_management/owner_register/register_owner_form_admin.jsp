...
$(document).ready(function(){
	...
	$("#ownerId").on("keyup", function(){
		$.ajax({
			url:"${initParam.rootPath}/owner/idDuplicatedCheck.do", //요청 url
			type:"POST",
			data: {ownerId:$("#ownerId").val()},//요청파라미터   id=aaaaa
...
<form action="${initParam.rootPath}/owner/add.do" method="post" id="regForm">
<!-- 요청 처리할 Controller에 대한 구분값 -->
<table border="1" style="width:600px">
	<tr>
		<th style="text-align: center; background-color: #FAE0D4;">점주 ID</th>
		<td><input type="text" id="ownerId" name="ownerId" size="25"> <span class="errorMessage" id="idErrorMessage"> <%-- <form:errors path="owner.ownerId"/>  --%></span></td>
	</tr>
	<tr>
		<th style="text-align: center; background-color: #FAE0D4;">패스워드</th>
		<td><input type="password" id="ownerPassword" name="ownerPassword" size="25"> <span class="errorMessage"><%-- <form:errors path="owner.ownerPassword"/> --%></span></td>
	</tr>
	<tr>
		<th style="text-align: center; background-color: #FAE0D4;">점주 이름</th>
		<td><input type="text" id="ownerName" name="ownerName" size="25"> <span class="errorMessage"><%-- <form:errors path="owner.ownerName"/> --%></span></td>
	</tr>
	<tr>
		<th style="text-align: center; background-color: #FAE0D4;">점주 전화번호</th>
		<td><input type="text" id="ownerPhone" name="ownerPhone" size="25"> <span class="errorMessage"><%-- <form:errors path="owner.ownerPhone"/> --%></span></td>
	</tr>
	<tr>
		<td colspan="2">
