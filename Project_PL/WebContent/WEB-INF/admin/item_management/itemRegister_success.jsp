	...
	<section>
		<div class="container">
			<div class="row">
				...
				물품을 등록/수정했습니다.<br> 등록한 정보는 다음과 같습니다.<br>
				<form enctype="multipart/form-data">
			<table border="1" style="width: 500px">
				<tr>
					<td rowspan="4"> <img src="${initParam.rootPath}/images/${requestScope.product.categoryId}/${requestScope.product.itemName}.png" alt="" /> 
						${requestScope.upImage}
					</td>
			...
			<a href="${initParam.rootPath }/admin/itemForm.do">뒤로 가기</a>	
	</div>
