			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->						
						<h3 style="color: #fe980f">아이디 찾기</h3>
						<h2 style="color: red" >${requestScope.errorMessage }</h2>
						<form action="${initParam.rootPath }/basic/findId.do" method="post" onsubmit="return findIdCheck();">
							이름을 입력하세요 <input type="text" name="name" placeholder="이름" id="name"/>
							핸드폰번호를 입력하세요 <input type="text" name="phoneNumber" placeholder="핸드폰번호" id="phoneNumber" />
