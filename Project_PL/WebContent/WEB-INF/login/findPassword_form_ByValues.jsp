				...
				<div class="row">
					<div class="col-sm-14">
						<div class="logo pull-left">
							<a href="${initParam.rootPath }/basic/item_list.do"><img src="${initParam.rootPath}/images/pline.png" alt="홈으로" /></a>
						</div>
					</div>
					<div class="col-sm-13">
			...
			<div class="row">
				<div class="col-sm-4 col-sm-offset-1">
					<div class="login-form"><!--login form-->						
						<h3 style="color: #fe980f">비밀번호 찾기</h3>
						<h2 style="color: red" >${requestScope.errorMessage }</h2>
						<form action="${initParam.rootPath }/basic/findPassword_2.do" method="post" onsubmit="return findPasswordCheck();">
							아이디를 입력해 주세요. 
							<input type="text" name="customerId" placeholder="아이디" id="customerId" style="margin-top: 15px"/>
							이름을 입력해 주세요. 
							<input type="text" name="customerName" placeholder="이름" id="customerName" style="margin-top: 15px"/>
							전화번호를 입력해 주세요. 
							<input type="text" name="customerPhoneNumber" placeholder="전화번호" id="customerPhoneNumber" style="margin-top: 15px"/>
