					...
					<div class="col-sm-13">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								...
								<li><a href="${initParam.rootPath }/basic/index.do"><iclass="fa fa-lock"></i> 로그아웃</a></li>
							</ul>
						</div>
					</div>
				</div>
			...
			<div class="row">
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items">
						<!--features_items-->
						<h2 class="title text-center">오늘의 음료</h2>
									...
									<div class="single-products">
										<div class="productinfo text-center">
											...
											<a href="${initParam.rootPath}/customer/item.do?itemName=${pd.itemName}&categoryId=${pd.categoryId}&storeId=${requestScope.storeId}" class="btn btn-default add-to-cart">
												<i class="fa fa-shopping-cart"></i>물품 조회</a>
										</div>
					...
					<div class="recommended_items">
						<!--recommended_items-->
						<h2 class="title text-center">추천 음료</h2>
