			...
			<div class="row">
                     ...
                     <div class="product-image-wrapper">
                        <div class="single-products">
                              <div class="productinfo text-center">
                                 <img src="/Project_PL/images/${pd.categoryId }/${pd.itemName }.png" alt="" />
                                 <h2>${pd.itemPrice}</h2>
                                 <p>${pd.itemName }</p>
                                 <a href="${initParam.rootPath}/customer/item.do?itemName=${pd.itemName}&categoryId=${pd.categoryId}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>물품 조회</a>
                              </div>
               ...
               <div class="recommended_items"><!--recommended_items-->
                  ...
                  <div id="recommended-item-carousel" class="carousel slide" data-ride="carousel">
                     <div class="carousel-inner">
                        <div class="item active">   
                           <c:forEach items="${requestScope.list }" var="pd" begin="6" end="8">
                           <div class="col-sm-4">
                              <div class="product-image-wrapper">
                                 <div class="single-products">
                                    <div class="productinfo text-center">
                        ...
                        <div class="item">   
                           <c:forEach items="${requestScope.list }" var="pd" begin="9" end="11">
                           <div class="col-sm-4">
                              <div class="product-image-wrapper">
                                 <div class="single-products">
                                    <div class="productinfo text-center">
                                       ...
                                       <h2>${pd.itemPrice}</h2>
                                       <p>${pd.itemName }</p>
                                       <a href="${initParam.rootPath}/customer/item.do?itemName=${pd.itemName }&categoryId=${pd.categoryId}" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>장바구니 담기</a>
                                    </div>
