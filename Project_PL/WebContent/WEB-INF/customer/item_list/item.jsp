...
<head>
    ...
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="/Projehref="/Project_PL/images/ico/apple-touch-icon-144-precomposed.png">
				...
				<div class="row">
					<div class="col-sm-14">
						<div class="logo pull-left">
							<a href="${initParam.rootPath }/basic/item_list.do"><img src="/Project_PL/images/pline.png" alt="" /></a>
					...
					<div class="product-details"><!--product-details-->
						<div class="col-sm-5">
							<div class="view-product">
								<img src="/Project_PL/images/${requestScope.item.categoryId}/${requestScope.item.itemName}.png" alt="" />
								  ...
								  <!-- Wrapper for slides -->
								    <div class="carousel-inner">
										...
										<div class="item active">
										  ...
										  <a href="${initParam.rootPath}/customer/item.do?itemName=${show.itemName}&categoryId=${show.categoryId}"><img src="/Project_PL/images/${show.categoryId }/${show.itemName }.png" width="80px" height="80px" alt=""></a>
										  	</c:forEach>
										</div>
										<div class="item">
						...
						<div class="col-sm-7">
							...
							<form action="">
								...
								<span>
									...
									<input type="text" value="1" name="countItem"/>  <!-- 숫자만 들어오는것 오류 확인해야함 -->
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									...
									<form action="#">
										...
										<b>Rating: </b> <img src="/Project_PL/images/product-details/rating.png" alt="" />
								...
								<div class="item active">	
										...
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="/Project_PL/images/home/recommend1.jpg" alt="" />
													<h2>$56</h2>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="/Project_PL/images/home/recommend2.jpg" alt="" />
													<h2>$56</h2>
													<p>Easy Polo Black Edition</p>
													<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
												</div>
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="/Project_PL/images/home/recommend3.jpg" alt="" />
													<h2>$56</h2>
													<p>Easy Polo Black Edition</p>
													<button type="button" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Add to cart</button>
												</div>
